from far5_privacyExtracter import PrivacyExtracter
from far4_pdfMaker import PDFMaker
from far2_rag import RAGImplementation
from far3_translator import Translator
...
def mainCombined(url):
    ...
    if text:
        ...
        return [
            str(overviewResponse),
            str(overviewResponseHindi),
            str(legalityResponse),
            str(legalityResponseHindi),
        ]
    else:
        return [
            "No privacy policy found in this page",
            "इस पेज पर कोई गोपनीयता नीति नहीं मिली",
        ] * 2


"""out = mainCombined("https://www.google.com/")
print(f"{out[0]}\n\n{out[1]}\n\n{out[2]}\n\n{out[3]}")"""
